 ...
 */
public abstract class FbListReferenceBasic<T, C extends Collection<T>, S extends Size> extends FbRefData<C> implements
        ListReference<T, C, S>, ItemBindersDelegate.BindableListReference<T, C, S> {
