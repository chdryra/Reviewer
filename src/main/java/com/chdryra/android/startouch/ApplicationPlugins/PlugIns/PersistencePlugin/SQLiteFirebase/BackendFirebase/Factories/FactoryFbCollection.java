...
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.PersistencePlugin.SQLiteFirebase.BackendFirebase.Implementation.FbReviewIdList;
...
public class FactoryFbCollection {
    ...
    ReviewCollection newCollection(Firebase root, String name, AuthorId authorId, ReviewDereferencer dereferencer, SizeReferencer sizeReferencer) {
        FbReviewIdList list = new FbReviewIdList(root, mStructure, sizeReferencer, name, authorId, mMasterRepo, new ConverterCollectionItem());
