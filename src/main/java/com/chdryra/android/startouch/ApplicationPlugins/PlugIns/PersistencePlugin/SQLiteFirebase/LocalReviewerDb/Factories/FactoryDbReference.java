...
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.PersistencePlugin.SQLiteFirebase
        .LocalReviewerDb.Implementation.DataLoader;
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.PersistencePlugin.SQLiteFirebase
        .LocalReviewerDb.Implementation.DbCommentListRef;
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.PersistencePlugin.SQLiteFirebase
        .LocalReviewerDb.Implementation.DbDataListRef;
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.PersistencePlugin.SQLiteFirebase
        .LocalReviewerDb.Implementation.DbItemDereferencer;
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.PersistencePlugin.SQLiteFirebase
        .LocalReviewerDb.Implementation.ReviewerDbReference;
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.PersistencePlugin.SQLiteFirebase
...
public class FactoryDbReference {
    ...
    public ReviewReference newReference(RowReview review, ReviewerDbRepo repo) {
        ...
        ReviewInfo info = new ReviewInfo(id, review, review, new DatumAuthorId(id, review
                .getAuthorId()), review);
    ...
    public ReviewReference newReference(Review review, ReviewerDbRepo repo) {
        ReviewId id = review.getReviewId();
        ReviewInfo info = new ReviewInfo(id, review.getSubject(), review.getRating(), review
                .getAuthorId(), review.getPublishDate());
        return new ReviewerDbReference(info, repo, this);
    }
    ...
    newListReference(ReviewId id, ReviewerDbReadable db, DbTable<T> table,
        ...
        return new DbDataListRef<>(new DataLoader<>(id, id.toString(), db, table, idCol), this,
                converter);
    }

    public DbCommentListRef
    newCommentListReference(ReviewId id, ReviewerDbReadable db,
                            ColumnInfo<String> idCol, DbDataListRef.Converter<RowComment,
            DataComment> converter) {
        return new DbCommentListRef(new DataLoader<>(id, id.toString(), db, db.getCommentsTable()
                , idCol), this, converter);
    }
    ...
    public ReviewItemReference<DataSize> newSizeReference(SimpleItemReference
                                                                  .Dereferencer<DataSize>
                                                                  dereferencer) {
        return new SimpleItemReference<>(dereferencer);
    }

    public <T extends HasReviewId> ReviewItemReference<T> newItemReference(SimpleItemReference
                                                                                   .Dereferencer<T> dereferencer) {
        return new SimpleItemReference<>(dereferencer);
    }
}
