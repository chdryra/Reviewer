 ...
 */ //Classes
public class GridItemAddEditComments extends GridItemEdit<GvCommentList.GvComment> {
    private static final int COMMENT_AS_HEADLINE
            = RequestCodeGenerator.getCode("CommentAsHeadline");

    //Constructors
    public GridItemAddEditComments(LaunchableConfig<GvCommentList.GvComment> editorConfig,
