...
import com.chdryra.android.reviewer.View.Screens.MaiSplitComments;
 ...
 */
public class EditScreenComments extends EditScreenReviewDataImpl<GvCommentList.GvComment> {
    private static final GvDataType<GvCommentList.GvComment> TYPE =
            GvCommentList.GvComment.TYPE;

    public EditScreenComments(Context context, ReviewBuilderAdapter builder, FactoryReviewDataEditor editorFactory) {
