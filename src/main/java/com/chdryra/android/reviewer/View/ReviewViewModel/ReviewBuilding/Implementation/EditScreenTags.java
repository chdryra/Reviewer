 ...
 */
public class EditScreenTags extends EditScreenReviewDataImpl<GvTagList.GvTag> {
    ...
    public EditScreenTags(Context context, ReviewBuilderAdapter builder, DataValidator validator, FactoryReviewDataEditor editorFactory) {
