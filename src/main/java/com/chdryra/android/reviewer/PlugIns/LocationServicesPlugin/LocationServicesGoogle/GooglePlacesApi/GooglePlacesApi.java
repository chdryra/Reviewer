...
import com.chdryra.android.reviewer.LocationServices.Implementation.AddressesSuggesterImpl;
import com.chdryra.android.reviewer.LocationServices.Implementation.AutoCompleterImpl;
 ...
 */
public class GooglePlacesApi implements ReviewerLocationServices {
    ...
    public AddressesSuggester newAddressesSuggester() {
        return new AddressesSuggesterImpl(new AddressesProviderGp(mContext));
    }

    @Override
    public AutoCompleter newAutoCompleter(LocatedPlace locatedPlace) {
        return new AutoCompleterImpl(locatedPlace, new AutoCompleterGp(newGeoClient()));
    }
