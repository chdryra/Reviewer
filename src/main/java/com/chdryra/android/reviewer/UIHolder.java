 ...
 * {@link VgDataList.GvData} back and forth with
 ...
 * </p>
 *
 * @param <T>: the {@link VgDataList.GvData} type.
 ...
 */
interface UIHolder<T extends VgDataList.GvData> extends UIReviewData<T> {
