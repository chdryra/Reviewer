 ...
 */
public class ReviewLazyGet extends ReviewDynamic implements ReviewNode, CallbackRepository {
    ...
    public ReviewLazyGet(ReviewId id, DataSubject subject, DataRating rating,
