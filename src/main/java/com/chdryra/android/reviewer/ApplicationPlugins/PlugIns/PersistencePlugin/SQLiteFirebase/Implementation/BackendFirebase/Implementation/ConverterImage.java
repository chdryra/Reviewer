 ...
 */
public class ConverterImage implements FbDataReference.SnapshotConverter<DataImage> {
    ...
    public DataImage convert(DataSnapshot snapshot) {
        ...
        return value == null ? new DatumImage(mId) : new DatumImage(mId, ImageData.asBitmap(value.getBitmap()),
                new DatumDate(mId, value.getDate()), value.getCaption(), value.isCover());
    }
}
