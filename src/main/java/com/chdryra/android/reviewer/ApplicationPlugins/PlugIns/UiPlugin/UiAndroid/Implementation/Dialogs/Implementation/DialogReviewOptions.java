...
public class DialogReviewOptions extends DialogOneButtonFragment implements
    ...
    protected View createDialogUi() {
        ...
        final Command deleteCommand = factory.newDeleteCommand(reviewId);
        final Command shareCommand = factory.newShareCommand(reviewId);
        final Command copyCommand = factory.newCopyCommand(reviewId);
