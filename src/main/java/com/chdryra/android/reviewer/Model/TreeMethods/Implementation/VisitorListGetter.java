 ...
 */
public class VisitorListGetter<T extends HasReviewId> implements VisitorReviewNode{
    private IdableList<T> mData;
    private NodeDataGetter<? extends IdableList<T>> mGetter;

    public VisitorListGetter(NodeDataGetter<? extends IdableList<T>> getter) {
        mGetter = getter;
    }
    ...
    public void visit(@NonNull ReviewNode node) {
        ...
        IdableList<T> data = mGetter.getData(node);
