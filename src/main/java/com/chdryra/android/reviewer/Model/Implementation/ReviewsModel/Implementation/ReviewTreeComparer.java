...
public class ReviewTreeComparer {
    public boolean compareNodes(ReviewNode lhs, ReviewNode rhs) {
    ...
    public boolean compareTrees(ReviewNode lhs, ReviewNode rhs) {
    ...
    private boolean compareSubTrees(ReviewNode lhs, ReviewNode rhs) {
