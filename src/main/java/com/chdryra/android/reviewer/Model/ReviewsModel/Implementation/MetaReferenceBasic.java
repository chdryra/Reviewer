 ...
 */
public abstract class MetaReferenceBasic extends ReviewReferenceBasic implements MetaReference {
    private BindersManagerMeta mBinders;

    public MetaReferenceBasic(BindersManagerMeta binders) {
        super(binders);
        mBinders = binders;
    }

    @Override
    public BindersManagerMeta getBindersManager() {
        return mBinders;
    }
