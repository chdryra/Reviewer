...
public class FactoryBinders {
    public ReviewReferenceBinder bindTo(MetaReviewReference reference, ReviewReferenceBinder.DataSizeBinder sizebinder, @Nullable ReviewReferenceBinder.DataBinder dataBinder) {
