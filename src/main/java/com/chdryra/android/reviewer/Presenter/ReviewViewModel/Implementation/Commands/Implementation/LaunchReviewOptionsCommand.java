...
public class LaunchReviewOptionsCommand extends Command {
    ...
    public LaunchReviewOptionsCommand(LaunchableConfig optionsConfig) {
        mOptionsConfig = optionsConfig;
    }

    public LaunchReviewOptionsCommand(LaunchableConfig optionsConfig, DataAuthorId authorId) {
        mOptionsConfig = optionsConfig;
        mAuthorId = authorId;
    }
