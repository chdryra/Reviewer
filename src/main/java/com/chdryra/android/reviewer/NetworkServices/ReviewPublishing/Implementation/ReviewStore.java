 ...
 */
public class ReviewStore implements ReviewsArchiveMutable.Callback, RepoCallback, WorkStore<Review> {
    private final ReviewsArchiveMutable mRepo;
    private WorkStoreCallback<Review> mWorkStoreCallback;
    private String mFetching;

    public ReviewStore(ReviewsArchiveMutable repo) {
        mRepo = repo;
    }
