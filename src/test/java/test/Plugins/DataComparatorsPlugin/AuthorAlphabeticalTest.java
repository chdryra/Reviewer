...
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.DataComparatorsPlugin.DataComparatorsDefault.Implementation.AuthorComparator;
...
public class AuthorAlphabeticalTest extends ComparatorTest<AuthorName> {
    ...
    public void alphabeticalAscendingDifferentFirstLetter() {
        AuthorName A = new AuthorNameDefault("A" + RandomString.nextWord(), AuthorIdGenerator.newId());
        AuthorName B = new AuthorNameDefault("B" + RandomString.nextWord(), AuthorIdGenerator.newId());
        AuthorName C = new AuthorNameDefault("C" + RandomString.nextWord(), AuthorIdGenerator.newId());
    ...
    public void comparatorEqualityIgnoresCase() {
        String name = RandomString.nextWord();
        AuthorName author = new AuthorNameDefault(name, AuthorIdGenerator.newId());
        AuthorName authorLower = new AuthorNameDefault(name.toLowerCase(), AuthorIdGenerator.newId());
        AuthorName authorUpper = new AuthorNameDefault(name.toUpperCase(), AuthorIdGenerator.newId());
