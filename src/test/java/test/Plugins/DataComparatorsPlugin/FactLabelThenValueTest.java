...
import com.chdryra.android.startouch.ApplicationPlugins.PlugIns.DataComparatorsPlugin
        .DataComparatorsDefault.Implementation.FactLabelThenValue;
...
public class FactLabelThenValueTest extends ComparatorTest<DataFact> {
    ...
    public void labelAlphabeticalAscendingFirst_AscendingValueSecond() {
        DataFact AA = new DatumFact(RandomReviewId.nextReviewId(), RandomString.toRandomCase("A")
                , RandomString.toRandomCase("A"));
        DataFact AZ = new DatumFact(RandomReviewId.nextReviewId(), RandomString.toRandomCase("A")
                , RandomString.toRandomCase("Z"));
        DataFact BC = new DatumFact(RandomReviewId.nextReviewId(), RandomString.toRandomCase("B")
                , RandomString.toRandomCase("C"));
        DataFact CA = new DatumFact(RandomReviewId.nextReviewId(), RandomString.toRandomCase("C")
                , RandomString.toRandomCase("A"));
    ...
    public void labelAlphabeticalAscendingDifferentFirstLetter_SameValue() {
        ...
        DataFact factA = new DatumFact(RandomReviewId.nextReviewId(), "A" + RandomString.nextWord
                (), RandomString.toRandomCase(value));
        DataFact factB = new DatumFact(RandomReviewId.nextReviewId(), "B" + RandomString.nextWord
                (), RandomString.toRandomCase(value));
        DataFact factC = new DatumFact(RandomReviewId.nextReviewId(), "C" + RandomString.nextWord
                (), RandomString.toRandomCase(value));
    ...
    public void valueAscending_SameLabel() {
        ...
        DataFact fact1 = new DatumFact(RandomReviewId.nextReviewId(), RandomString.toRandomCase
                (label), "A");
        DataFact fact2 = new DatumFact(RandomReviewId.nextReviewId(), RandomString.toRandomCase
                (label), "B");
        DataFact fact3 = new DatumFact(RandomReviewId.nextReviewId(), RandomString.toRandomCase
                (label), "C");
    ...
    public void comparatorEqualityIgnoresLabelCase_SameValue() {
        ...
        DataFact factLower = new DatumFact(RandomReviewId.nextReviewId(), label.toLowerCase(),
                value.toUpperCase());
        DataFact factUpper = new DatumFact(RandomReviewId.nextReviewId(), label.toUpperCase(),
                value.toLowerCase());
