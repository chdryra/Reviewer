...
public class ComparitorGvLocationTest extends TestCase {
    ...
    public void testCompareSame() {
        DifferenceLocation differenceLocation = mLocationComparitor.compare(TAYYABS_LOC, TAYYABS_LOC);
        DifferenceLocation expected = new DifferenceLocation(ZERO_DIST, ZERO_NAME);
        DifferenceLocation maxDiff = new DifferenceLocation(mTayyabsLkhDistDiff, mTayyabsLkhNameDiff);
    ...
    public void testCompareTypo() {
        DifferenceLocation differenceLocation = mLocationComparitor.compare(TAYYABS_LOC, TAYYBBS_LOC);
    ...
    public void testCompareDistanceDiff() {
        DifferenceLocation differenceLocation = mLocationComparitor.compare(TAYYABS_LOC, TAYYABS_LOC2);
        DifferenceLocation zeroDiff = new DifferenceLocation(ZERO_DIST, ZERO_NAME);
    ...
    public void testCompareTypoAndDistanceDiff() {
        DifferenceLocation differenceLocation = mLocationComparitor.compare(TAYYABS_LOC, TAYYBBS_LOC2);
        DifferenceLocation zeroDiff = new DifferenceLocation(ZERO_DIST, ZERO_NAME);
    ...
    public void testCompareTayyabsLkh() {
        ...
        DifferenceLocation expected = new DifferenceLocation(mTayyabsLkhDistDiff, mTayyabsLkhNameDiff);
        assertFalse(differenceLocation.lessThanOrEqualTo(zeroDiff));
